 ...
 * 
 * @param category, `@example` (category, brand, product, ...ect)
 ...
 */
exports.resizeImage = (category, department, width, height, imageFormat, imageQuality) => asyncHandler(async (req, res, next) => {
